            ...
            <form action="user_update.php" method="post" enctype="multipart/form-data">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  <label>NAMA</label>
                  <input type="text" class="form-control" name="user_nama" value="<?php echo $d['user_nama'] ?>" required="required">
                ...
                <div class="form-group">
                  <label>Level</label>
                  <select class="form-control" name="user_level" required="required">
