...
if($jumlah > $kembalikan_jumlah){
	...
	mysqli_query($koneksi,"update barang_keluar set bk_id='$barang', bk_nama_barang='$nama_barang', bk_tgl_keluar='$tanggal', bk_jumlah_keluar='$jumlah', bk_lokasi='$lokasi', bk_penerima='$penerima', bk_keterangan='$keterangan' where bk_id='$id'");
