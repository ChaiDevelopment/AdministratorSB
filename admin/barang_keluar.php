                  ...
                  <form action="barang_keluar_act.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="barang" required="required">
                        ...
                        $barang = mysqli_query($koneksi,"SELECT * FROM barang"); // Query untuk mengambil data barang dari tabel barang
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="table-datatable">
              ...
              <tbody>
                <?php 
                $no=1;
                $query = "SELECT * FROM barang_keluar"; // Query untuk mengambil data barang keluar dari tabel barang_keluar
                ...
                if ($data) {
                  ...
                  echo "Error executing query: " . mysqli_error($koneksi); // Tampilkan pesan error jika query gagal
                }
                ?>
              </tbody>
            </table>
